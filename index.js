...
app.delete('/api/users', authenticate, (req, res) => {
...
app.post('/api/users/itineraries', authenticate, (req, res) => {
...
app.delete('/api/users/itineraries/:id', authenticate, (req, res) => {
...
app.patch('/api/users/itineraries/:id', authenticate, (req, res) => {
  const userId = req.user._id
  const itineraryId = req.params.id
  if (!ObjectID.isValid(itineraryId)) {
    return res.status(404).send()
...
app.get('/api/test', (req, res) => {
  res.send("your server's working")
})
